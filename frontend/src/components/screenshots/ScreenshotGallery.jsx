...
// Asegurarse de que los métodos dependientes estén en el useCallback correcto
...
// Modificar useEffect para usar fetchScreenshots como callback
useEffect(() => {
  if (propsScreenshots) {
  ...
  fetchScreenshots();
}, [propsScreenshots, playerId, id, applyFilters, fetchScreenshots]);
